...
- V1 raster imagery for Hero (desktop/mobile crops) and Testimonials (3 headshots)
- Integrated responsive image logic in HeroSection
- Updated Testimonials with generated persona images
